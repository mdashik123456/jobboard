                            ...
                            @if (session()->has('id') && session()->has('type'))
                                {{-- <a href="{{ url('/login') }}"
                                    class="btn btn-outline-white border-width-2 d-none d-lg-inline-block"><span
                                        ...
                                        <div class="dropdown">
                                          <button class="btn btn-outline-white border-width-2 d-none d-lg-inline-block" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            Dashboard
                                          </button>
